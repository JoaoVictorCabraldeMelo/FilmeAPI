...
namespace FilmeAPI.Migrations
{
    ...
    [Migration("20231224002959_AddForeignKeys")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmeAPI.Cinema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmeAPI.Sessao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmeAPI.Cinema", b =>
                {
                    b.HasOne("FilmeAPI.Models.Endereco", "Endereco")
                        .WithOne("Cinema")
                        .HasForeignKey("FilmeAPI.Cinema", "EnderecoId")
            ...
            modelBuilder.Entity("FilmeAPI.Sessao", b =>
                {
                    b.HasOne("FilmeAPI.Cinema", "Cinema")
                        .WithMany("Sessoes")
